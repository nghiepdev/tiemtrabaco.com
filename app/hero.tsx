    ...
    <div className="relative flex items-center justify-center min-h-[80vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center w-full">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-4 animate-fade-in">
          <span className="bg-linear-to-r from-yellow-100 via-violet-200 to-fuchsia-200 bg-clip-text text-transparent drop-shadow-lg [@supports(not(background-clip:text))]:text-white">
            Tiệm Trà BaCo
          </span>
        </h1>
        ...
        <a
          ...
          aria-label="Xem vị trí của chúng tôi trên bản đồ: Xã Hoà Đồng, huyện Tây Hoà, Tỉnh Phú Yên"
        >
          ...
          <address className="text-center flex-1 not-italic">
            ...
            <p className="text-sm text-white/70 mt-1 group-hover:text-white/90 transition-colors">
              <span aria-hidden="true">📍</span> Nhấn để xem bản đồ
            </p>
          </address>
        ...
        <div className="flex gap-4 items-center animate-fade-in delay-300">
          <a
            ...
            aria-label="Liên hệ với chúng tôi qua Facebook Messenger để đặt món"
          >
          ...
          <a
            ...
            aria-label="Xem thư viện ảnh menu"
          >
            Xem menu
          </a>
        </div>
